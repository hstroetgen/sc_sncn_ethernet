...
#include "_ethernet_tx_client_full.h"
#include "print.h"
...
{
  unsigned sentTime;
  _ethernet_send_frame_unify(ethernet_tx_svr, Buf, count, sentTime, ETHERNET_TX_REQ, ifnum);
  return;
}
...
{
  _ethernet_send_frame_unify(ethernet_tx_svr, Buf, count, sentTime, ETHERNET_TX_REQ_TIMED, ifnum);
  return;
}
