...
#ifndef _ETHERNET_RX_CLIENT_FULL_P1_H_
#define _ETHERNET_RX_CLIENT_FULL_P1_H_ 1
#include <xccompat.h>
 ...
 */
void _mac_get_link_counters(chanend mac_svr, REFERENCE_PARAM(int,overflow));
 ...
 */
void _mac_get_tile_timer_offset(chanend mac_svr, REFERENCE_PARAM(int, offset));
