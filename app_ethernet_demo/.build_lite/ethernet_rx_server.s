	.file	"/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p2/ethernet_rx_server.xc"
	...
	.set usage.anon.30,0
	.set usage.anon.31,0
	.globread usage.anon.31,usage.anon.29,"/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p2/ethernet_rx_server.xc:290: error: previously used here"
	.globwrite ethernet_rx_server,usage.anon.30,"/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p2/ethernet_rx_server.xc:387: error: previously used here"
	.globwrite ethernet_rx_server,usage.anon.29,"/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p2/ethernet_rx_server.xc:393: error: previously used here"
	.globwrite usage.anon.31,usage.anon.30,"/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p2/ethernet_rx_server.xc:311: error: previously used here"
	.globwrite serviceLinkCmd,usage.anon.30,"/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p2/ethernet_rx_server.xc:124: error: previously used here"
	.globwrite serviceLinkCmd,usage.anon.29,"/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p2/ethernet_rx_server.xc:99: error: previously used here"
	.call ethernet_rx_server,usage.anon.31
	.call ethernet_rx_server,usage.anon.27
	...
	.call serviceLinkCmd,ethernet_get_filter_counts
	...
	.assert 1,usage.anon.9.actnochandec,"/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p2/ethernet_rx_server.xc:181: error: call to function `mii_packet_get_src_port' which declares a channel from within a transaction statement"
	.assert 1,usage.anon.5.actnochandec,"/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p2/ethernet_rx_server.xc:195: error: call to function `mii_packet_get_timestamp' which declares a channel from within a transaction statement"


	.file	1 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p2/ethernet_rx_server.xc"
...
.Leh_func_end1:
	...
	.set	serviceLinkCmd.nstackwords,((ethernet_get_mii_counts.nstackwords $M ethernet_get_filter_counts.nstackwords) + 8)
	.globl	serviceLinkCmd.nstackwords
	.set	serviceLinkCmd.maxcores,ethernet_get_filter_counts.maxcores $M ethernet_get_mii_counts.maxcores $M 1
	.globl	serviceLinkCmd.maxcores
	.set	serviceLinkCmd.maxtimers,ethernet_get_filter_counts.maxtimers $M ethernet_get_mii_counts.maxtimers $M 0
	.globl	serviceLinkCmd.maxtimers
	.set	serviceLinkCmd.maxchanends,ethernet_get_filter_counts.maxchanends $M ethernet_get_mii_counts.maxchanends $M 0
...
.Ltmp206:
.Ltmp207:
	.size	mac_rx_send_frame1, .Ltmp207-mac_rx_send_frame1
.Lfunc_end2:
.Ltmp208:
	.cfi_endproc
.Leh_func_end2:
...
.Ltmp227:
.Ltmp228:
	.size	mac_rx_send_frame0, .Ltmp228-mac_rx_send_frame0
.Lfunc_end3:
.Ltmp229:
	.cfi_endproc
.Leh_func_end3:
...
.Linfo_begin1:
	...
	.byte	0
	.short	49152
	.ascii	 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p2/ethernet_rx_server.xc"
	.byte	0
	.long	0
	.long	.Lsection_line
...
.Ldebug_loc137:
	...
	.typestring mac_rx_send_frame0, "f{0}(&(s(mii_packet_t){m(length){si},m(timestamp){si},m(filter_result){si},m(src_port){si},m(timestamp_id){si},m(stage){si},m(tcount){si},m(crc){si},m(forwarding){si},m(data){a(380:ui)}}),chd,ui)"
