# 1 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii_malloc.c"
...
# 9 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii_full.h" 2
...
# 10 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii_full.h" 2
...
# 7 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii_malloc.c" 2
...
# 8 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii_malloc.c" 2
...
# 12 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii_malloc.c" 2
                                  ...
                                  unsigned *end_ptr)
{
  ...
  if (rdptr > wrptr) {
    space_left = (char *) rdptr - (char *) wrptr;
    if (space_left < ((sizeof(_mii_packet_t) - (((1518)+3)/4)*4)+sizeof(malloc_hdr_t)+4*10))
      return 0;
  } else {
...
void _mii_commit(mii_buffer_t buf, int endptr0)
{
  ...
  _mii_packet_t *pkt;
  int *end = info->end;
  pkt = (_mii_packet_t *) buf;
  pkt->stage = 0;




  if (((int) (char *) end - (int) (char *) end_ptr) < ((sizeof(_mii_packet_t) - (((1518)+3)/4)*4)+sizeof(malloc_hdr_t)+4*10))
    end_ptr = info->start;
...
int _mii_update_my_rdptr(mii_mempool_t mempool, int rdptr0)
{
  ...
  next = hdr->next;
# 208 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii_malloc.c"
  return next;
}
