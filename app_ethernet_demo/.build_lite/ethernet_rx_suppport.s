	.file	"/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p2/ethernet_rx_suppport.c"
...
.set mac_rx_send_frame.locnonotificationselect, 1
	...
	.file	1 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p2/ethernet_rx_suppport.c"
...
.Linfo_begin1:
	...
	.byte	0
	.short	1
	.ascii	 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p2/ethernet_rx_suppport.c"
	.byte	0
	.long	0
	.long	.Lsection_line
...
.Ldebug_loc6:
	...
	.typestring mac_rx_send_frame0, "f{0}(p(s(mii_packet_t){m(length){si},m(timestamp){si},m(filter_result){si},m(src_port){si},m(timestamp_id){si},m(stage){si},m(tcount){si},m(crc){si},m(forwarding){si},m(data){a(380:ui)}}),ui,ui)"
