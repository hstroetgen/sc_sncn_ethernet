# 1 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii.xc"
# 6 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii.xc"
# 1 "xs1.h" 1 3
# 19 "xs1.h" 3
# 1 "timer.h" 1 3
# 33 "timer.h" 3
...
# 7 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii.xc" 2
# 1 "_mii_queue.h" 1
# 9 "_mii_queue.h"
# 1 "xccompat.h" 1 3
# 201 "xccompat.h" 3
...
# 8 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii.xc" 2
# 1 "_mii.h" 1
# 4 "_mii.h"
# 1 "xs1.h" 1 3
# 5 "_mii.h" 2
...
# 9 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii.xc" 2
# 1 "_mii_malloc.h" 1
# 3 "_mii_malloc.h"
# 1 "_mii_full.h" 1
# 8 "_mii_full.h"
...
# 10 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii.xc" 2
# 1 "print.h" 1 3
# 34 "print.h" 3
...
# 11 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii.xc" 2
# 1 "stdlib.h" 1 3
# 4 "stdlib.h" 3
# 1 "stdlib.h" 1 3
# 10 "stdlib.h" 3
...
# 6 "stdlib.h" 2 3
# 12 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii.xc" 2
# 1 "syscall.h" 1 3
# 48 "syscall.h" 3
...
# 59 "xclib.h" 3
int clz(unsigned x);
# 15 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii.xc" 2
# 129 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii.xc"
static unsigned int _ethernet_mii_no_queue_entries = 0;

void _ethernet_get_mii_counts(unsigned& dropped) {
	dropped = _ethernet_mii_no_queue_entries;
}
# 136 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii.xc"
#pragma unsafe arrays
void _mii_rx_pins(
# 141 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii.xc"
...
# 152 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii.xc"
        unsigned wrap_ptr_lp;
# 157 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii.xc"
	...
	while (1)
	{
# 163 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii.xc"
#pragma xta label "mii_rx_begin"
        ...
        unsigned end_ptr_lp;
# 181 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii.xc"
		buf_lp = _mii_reserve(rxmem_lp, end_ptr_lp);
# 191 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii.xc"
#pragma xta endpoint "mii_rx_sof"
		p_mii_rxd when  __builtin_pins_eq(0xD)  :> int sof;
# 194 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii.xc"
#pragma xta endpoint "mii_rx_after_preamble"
		tmr :> time;

		if (buf_lp) {
			dptr_lp = _mii_packet_get_data_ptr(buf_lp);
# 203 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii.xc"
		} else {
# 204 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii.xc"
#pragma xta label "mii_no_availible_buffers"
		...
		crc = 0x9226F562;
# 221 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii.xc"
#pragma xta endpoint "mii_rx_first_word"
		p_mii_rxd :> word;
		__builtin_crc32(crc, word, poly) ;
		asm("stw %0,%1[" "0" "]"::"r"(word),"r"(dptr_lp)); ;
# 229 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii.xc"
#pragma xta endpoint "mii_rx_second_word"
		p_mii_rxd :> word;
		__builtin_crc32(crc, word, poly) ;
		asm("stw %0,%1[" "1" "]"::"r"(word),"r"(dptr_lp)); ;
# 237 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii.xc"
#pragma xta endpoint "mii_rx_third_word"
		p_mii_rxd :> word;
		__builtin_crc32(crc, word, poly) ;
		asm("stw %0,%1[" "2" "]"::"r"(word),"r"(dptr_lp)); ;
# 246 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii.xc"
#pragma xta endpoint "mii_rx_ethertype_word"
		p_mii_rxd :> word;
		__builtin_crc32(crc, word, poly) ;
		asm("stw %0,%1[" "3" "]"::"r"(word),"r"(dptr_lp)); ;
# 254 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii.xc"
		{
# 271 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii.xc"
		buf = buf_lp;
		dptr = dptr_lp;
...
# 278 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii.xc"
#pragma xta endpoint "mii_rx_fifth_word"
		...
		if (!buf) {
# 284 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii.xc"
...
# 294 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii.xc"
#pragma xta endpoint "mii_rx_sixth_word"
		...
		do
		{
# 306 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii.xc"
#pragma xta label "mii_rx_data_inner_loop"
			select
			{
# 309 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii.xc"
#pragma xta endpoint "mii_rx_word"
				case p_mii_rxd :> word:
                                  ...
                                  break;
# 320 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii.xc"
#pragma xta endpoint "mii_rx_eof"
				case p_mii_rxdv when  __builtin_pins_eq(0)  :> int lo:
				{
# 323 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii.xc"
...
# 464 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii.xc"
...
# 480 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii.xc"
...
# 490 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii.xc"
#pragma xta endpoint "mii_tx_first_word"
	...
	do {
# 497 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii.xc"
#pragma xta label "mii_tx_loop"
          ...
          i++;
          __builtin_crc32(crc, word, poly) ;
# 504 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii.xc"
#pragma xta endpoint "mii_tx_word"
		p_mii_txd <: word;
	} while (i < word_count);
# 513 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii.xc"
	switch (tail_byte_count)
	{
		case 0:
			__builtin_crc32(crc, 0, poly) ;
			crc = ~crc;
# 518 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii.xc"
...
# 524 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii.xc"
#pragma xta endpoint "mii_tx_final_partword_1"
			__builtin_partout(p_mii_txd, 8, word) ;
			__builtin_crc32(crc, 0, poly) ;
			crc = ~crc;
# 528 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii.xc"
#pragma xta endpoint "mii_tx_crc_1"
			p_mii_txd <: crc;
			break;
		case 2:
			word = _mii_packet_get_data_word(dptr, 0);
# 533 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii.xc"
#pragma xta endpoint "mii_tx_final_partword_2"
			...
			__builtin_crc32(crc, 0, poly) ;
			crc = ~crc;
# 539 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii.xc"
#pragma xta endpoint "mii_tx_crc_2"
			p_mii_txd <: crc;
			break;
		case 3:
			word = _mii_packet_get_data_word(dptr, 0);
# 544 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii.xc"
#pragma xta endpoint "mii_tx_final_partword_3"
			...
			__builtin_crc32(crc, 0, poly) ;
			crc = ~crc;
# 551 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii.xc"
#pragma xta endpoint "mii_tx_crc_3"
			p_mii_txd <: crc;
			break;
	}
}
# 558 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii.xc"
#pragma unsafe arrays
void _mii_tx_pins(
# 569 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii.xc"
		mii_mempool_t lp_queue,
		mii_ts_queue_t &ts_queue,
		out buffered port:32 p_mii_txd,
		int ifnum)
{
# 579 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii.xc"
	int prev_eof_time, time;
	timer tmr;
	int ok_to_transmit=1;
# 586 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii.xc"
	while (1) {
# 587 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii.xc"
#pragma xta label "mii_tx_main_loop"
		unsigned buf;
		int bytes_left;

		int stage;
# 647 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii.xc"
		buf = _mii_get_next_buf(lp_queue);
# 667 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii.xc"
		tmr :> time;
...
# 673 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii.xc"
#pragma xta endpoint "mii_tx_not_valid_to_transmit"
			continue;
		}

		if (_mii_packet_get_stage(buf) != 1) {
# 678 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii.xc"
#pragma xta endpoint "mii_tx_buffer_not_marked_for_transmission"
			continue;
		}
# 682 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii.xc"
#pragma xta endpoint "mii_tx_start"
		_mii_transmit_packet(buf, p_mii_txd, tmr);
# 684 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii.xc"
...
# 706 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii.xc"
void _mii_init_full(_mii_interface_full_t &m) {
...
# 722 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii.xc"
...
# 749 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_mii.xc"
