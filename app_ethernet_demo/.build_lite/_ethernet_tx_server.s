	.file	"/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_ethernet_tx_server.xc"
	...
	.call _ethernet_tx_server,_mii_reserve_at_least
	.call _ethernet_tx_server,_mii_get_wrap_ptr
	.call _ethernet_tx_server,_mii_free
	.call _ethernet_tx_server,_mii_commit
	...
	.file	1 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_ethernet_tx_server.xc"
...
.Leh_func_end0:
	...
	.set	_ethernet_tx_server.nstackwords,((memset.nstackwords $M _get_ts_queue_entry.nstackwords $M _get_and_dec_transmit_count.nstackwords $M _mii_free.nstackwords $M smi_check_link_state.nstackwords $M _ethernet_update_link_status.nstackwords $M _mii_reserve_at_least.nstackwords $M _mii_get_wrap_ptr.nstackwords $M _mii_commit.nstackwords) + 38)
	.globl	_ethernet_tx_server.nstackwords
	.set	_ethernet_tx_server.maxcores,_ethernet_update_link_status.maxcores $M _get_and_dec_transmit_count.maxcores $M _get_ts_queue_entry.maxcores $M _mii_commit.maxcores $M _mii_free.maxcores $M _mii_get_wrap_ptr.maxcores $M _mii_reserve_at_least.maxcores $M smi_check_link_state.maxcores $M 1
	.globl	_ethernet_tx_server.maxcores
	.set	_ethernet_tx_server.maxtimers,_ethernet_update_link_status.maxtimers $M _get_and_dec_transmit_count.maxtimers $M _get_ts_queue_entry.maxtimers $M _mii_commit.maxtimers $M _mii_free.maxtimers $M _mii_get_wrap_ptr.maxtimers $M _mii_reserve_at_least.maxtimers $M smi_check_link_state.maxtimers $M 0
	.globl	_ethernet_tx_server.maxtimers
	.set	_ethernet_tx_server.maxchanends,_ethernet_update_link_status.maxchanends $M _get_and_dec_transmit_count.maxchanends $M _get_ts_queue_entry.maxchanends $M _mii_commit.maxchanends $M _mii_free.maxchanends $M _mii_get_wrap_ptr.maxchanends $M _mii_reserve_at_least.maxchanends $M smi_check_link_state.maxchanends $M 0
...
.Linfo_begin1:
	...
	.byte	0
	.short	49152
	.ascii	 "/home/atena/workspace_ethernet_new_replicated/module_ethernet_dual/src/full_p1/_ethernet_tx_server.xc"
	.byte	0
	.long	0
	.long	.Lsection_line
...
.Ldebug_loc81:
	...
	.typestring _mii_reserve_at_least, "f{ui}(ui,&(ui),si)"
