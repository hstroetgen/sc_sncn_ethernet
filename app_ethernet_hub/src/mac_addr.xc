...
void init_macAddress_p2(char mac[6]){

    mac[0] = MAC_ADDRESS_P2[0];
    mac[1] = MAC_ADDRESS_P2[1];
    mac[2] = MAC_ADDRESS_P2[2];
    mac[3] = MAC_ADDRESS_P2[3];
    mac[4] = MAC_ADDRESS_P2[4];
    mac[5] = MAC_ADDRESS_P2[5];
